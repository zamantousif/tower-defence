...
class Enemy : public Object {
 public:
  ...
  /// enemy \param sprite           Texture of the enemy \param health Health of
  /// the enemy \param move_speed       Movement speed of the enemy \param
  /// bounty           Bounty of the enemy \param armored          Status of
  /// enemy armor \param moved_distance   Total distance moved on the path by
  /// the enemy
