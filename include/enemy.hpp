...
namespace td {
  ...
  class Enemy : public Object {
   public:
    ...
    Enemy(sf::Vector2<float> position, sf::CircleShape hitbox, sf::Texture sprite, float health = 100.0f,
          int move_speed = 1, float bounty = 0.0f, bool armored = false, float distance_moved = 0.0f);
